package com.example.collegeassistant.db;
...
import com.example.collegeassistant.Note_work;
...
public class DatabaseAccess {
    ...
    public void save(Note_work memo) {
    ...
    public void update(Note_work memo) {
        ContentValues values = new ContentValues();
    ...
    public void delete(Note_work memo) {
        String date = Long.toString(memo.getTime());
    ...
    public List getAllMemos() {
        ...
        while (!cursor.isAfterLast()) {
            ...
            memos.add(new Note_work(time, text));
            cursor.moveToNext();
        }
        cursor.close();
        return memos;
